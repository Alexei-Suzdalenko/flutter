  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar( title: Text(
        AppLocalizations.of(context).translate('new_work'),
            ...
            children: [
              ...
              RaisedButton(
                ...
                onPressed: () {
                  ...
                  adminSaveNewWork(widget.company_id , workName.text.trim(), workAdress.text.trim(), workPrice.text, 'boss').then((value){
                    if(value == 'ok'){
                      Fluttertoast.showToast(
                          msg: AppLocalizations.of(context).translate('work_added'),
                          toastLength: Toast.LENGTH_LONG ,
                          gravity: ToastGravity.BOTTOM,
                          timeInSecForIosWeb: 3,
                      ...
                      Navigator.of(context).pushNamedAndRemoveUntil('/boss', (Route<dynamic> route) => false, arguments: ScreenArguments(widget.company_id, 'key', 'value'));
                    } else {
                      Fluttertoast.showToast(
