...
class MenuDrawerManager extends StatefulWidget {
  @override
  _MenuDrawerManagerState createState() => _MenuDrawerManagerState();
}

class _MenuDrawerManagerState extends State<MenuDrawerManager> {
  @override
      ...
      child: Column(
        children: [
            ...
            child: Center(
              child: Column(
                children: [
                  ...
                  Text(AppLocalizations.of(context).translate('manager'), style: TextStyle(fontSize: 14, color: Colors.white),),
                ],
              ),
            ),
          ),
          ...
          ListTile(
            ...
            title: Text(AppLocalizations.of(context).translate('workers'), style: TextStyle(color:Colors.black87, fontSize: 17.0,),),
            onTap: (){
              getCompaniId().then((company_id) {
